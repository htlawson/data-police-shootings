...
To filter the data (known race and date, year after 2014):
...
fatal_shootings_known_race <- fatal_shootings_known_race %>%
...
# Total number of shootings where race is known
